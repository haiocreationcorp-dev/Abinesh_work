          ...
          <div style={styles.sliders}>
            <div style={styles.intensityBox}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2 }}>
                <span style={{ fontSize: 13, fontWeight: 700, color: PURPLE }}>Effect Strength</span>
              ...
              <input
                ...
                style={{ width: '100%', accentColor: PURPLE, display: 'block' }}
              />
...
const styles = {
  ...
  sliders: { display: 'flex', flexDirection: 'column', gap: 10, maxWidth: 420 },
