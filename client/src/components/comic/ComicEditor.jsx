        ...
        {activeSidebar === 'CHARACTER' ? (
          <>
            <button
              ...
              onClick={() => { setActiveSidebar(null); setCharacterMenu(null); }}
              title="Back"
            >
              <IconBack />
            ...
            {[...CHARACTER_DIMENSIONS, CHARACTER_SKIN_TOOL, CHARACTER_EYE_TOOL, ...CHARACTER_COLOR_TOOLS].map((item) => {
              ...
              return (
                <button
                  key={item.id}
                  style={{ ...styles.iconBtn, ...(characterMenu === item.id ? styles.iconBtnActive : {}) }}
                  onClick={() => setCharacterMenu((prev) => (prev === item.id ? null : item.id))}
                  title={item.label}
                >
                  <Icon />
