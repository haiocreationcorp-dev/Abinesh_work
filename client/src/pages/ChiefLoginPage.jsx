...
export default function ChiefLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user.role !== 'INSTITUTION_CHIEF') {
        setError('This login is for institution chiefs only.');
        return;
      }
      saveSession(token, user);
      navigate('/chief/billing');
    } catch (err) {
  ...
  return (
    <div style={styles.root}>
      <div className="card" style={styles.card}>
        ...
        <h2 style={styles.sub}>🏛️ Institution Chief Sign In</h2>
