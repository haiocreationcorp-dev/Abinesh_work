...
const styles = {
  ...
  statCard: { borderRadius: 'var(--radius)', padding: 24, color: '#fff', transition: 'transform 200ms ease, box-shadow 200ms ease' },
  statCardTop: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 },
  statIconWrap: { width: 40, height: 40, borderRadius: '50%', background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  statValueLg: { fontSize: 32, fontWeight: 800, marginBottom: 4 },
  statLabelLg: { fontSize: 14, fontWeight: 700, marginBottom: 2 },
  statDesc: { fontSize: 12, opacity: 0.85 },
  statSparkline: { marginTop: 10 },
